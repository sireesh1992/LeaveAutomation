...
<s:form action="changePassword">
	<s:submit name="PasswordChange" value="Change Password"/>
		...
		<s:form action="checkReport">
					<s:submit name="checkReport" value="View Leave Reports"></s:submit>
				</s:form>
			
			<s:form action="createNewEmployee">
					<s:submit name="createEmployee" value="Create New Employee"></s:submit>
				</s:form>
				
		<s:form action="deleteEmployee">
					<s:submit name="deleteEmployee" value="Delete Employee"></s:submit>
				</s:form>
