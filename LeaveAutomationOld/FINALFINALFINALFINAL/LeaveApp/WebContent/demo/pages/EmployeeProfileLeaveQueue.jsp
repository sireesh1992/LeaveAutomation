...
<body>
	<table>
		<tr>
			<td style="text-align: right"><a
				href="http://localhost:8080/LeaveApp/demo/input.action">Logout</a></td>
		</tr>
	</table>
	...
	<table>
		...
		<s:iterator value="leaveStatusQueue" >
			<s:form action="leaveCancel" theme="simple">
				<tr>
					...
					<td><s:submit  name="cancel" value="cancel" /></td>
				</tr>
			</s:form>
		</s:iterator>
	</table>
