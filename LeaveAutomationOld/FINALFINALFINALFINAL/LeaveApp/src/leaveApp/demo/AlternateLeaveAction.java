...
public class AlternateLeaveAction extends ActionSupport {
	/**
	 * 
	 */
	...
	System.out.println("this is thge striung start date "+startDate);
	Date sd = df.parse(startDate);
	System.out.println("start date in leavew action "+sd);
